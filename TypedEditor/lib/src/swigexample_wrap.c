...
extern "C" {
#endif
static int _wrap_name_get(lua_State* L) {
  int SWIG_arg = 0;
  char *result = 0 ;
  
  SWIG_check_num_args("name",0,0)
...
static int _wrap_print_hello(lua_State* L) {
  int SWIG_arg = 0;
  
  SWIG_check_num_args("print_hello",0,0)
  print_hello();
...
static swig_lua_attribute swig_SwigModule_attributes[] = {
    { "name", _wrap_name_get, SWIG_Lua_set_immutable },
    {0,0,0}
};
